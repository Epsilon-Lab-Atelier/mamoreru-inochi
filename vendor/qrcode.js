 ...
 * MIT License
 * Bundled locally for 守れるいのち. No external network dependency.
 */
(function (global) {
  'use strict';
...
module.exports = QRCode;
  ...
  function requireLocal(id) {
    ...
    if (!factory) throw new Error('QR module not found: ' + key);
    const module = { exports: {} };
    cache[key] = module;
    factory(module, module.exports, requireLocal);
    return module.exports;
  }
  global.MamoreruQRCode = requireLocal('index');
  global.MamoreruQRErrorCorrectLevel = requireLocal('QRErrorCorrectLevel');
})(globalThis);
